<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="Agent.SignUpPage" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="content" runat="server">
    ...
    <table>
        <tbody>
            ...
            <tr>
                <td colspan="2">
                    <asp:Button ID="Button1" runat="server" Text="Register" OnClick="BRegisterUser_Click" CssClass="login-button" />
                </td>
            </tr>
        </tbody>
    </table>
